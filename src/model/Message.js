    ...
    getViewElement(me = true){
        ...
        switch (this.type) {
            case 'contact':
                ...
                div.querySelector('.btn-message-send').on('click', event=>{
                    console.log('Enviar mensagem para', this.content);
                })
                break;
        ...
        if(me){
            ...
            let status = this.getStatusViewElement();
            div.querySelector('.message-time').parentElement.appendChild(status);
        }
